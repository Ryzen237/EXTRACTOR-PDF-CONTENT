...
class AIExtractorImproved:
    ...
    def _clean_text(self, text: str) -> str:
        ...
        # Correction des espaces dans les mots
    ...
    async def _extract_personal_info(self, text: str) -> Dict[str, str]:
        ...
        try:
            ...
            # Recherche du nom complet (pattern plus intelligent)
            name_patterns = [
            ...
            if 'full_name' not in personal_info:
                ...
                for line in lines[:10]:
                    line = line.strip()
                    if line and len(line) > 5 and not re.search(r'\d', line) and not re.search(r'[^\w\s]', line):
    ...
    async def _extract_work_experience(self, text: str) -> List[Dict[str, str]]:
        ...
        try:
            ...
            exp_patterns = [
                r'(?:Intern|Stagiaire|Développeur|Developer|Mobile Developer)[^.\n]*',
                r'(?:COM\.INFO|Devsec|PRODITECH|ENSPD)[^.\n]*',
                r'(?:Douala)[^.\n]*'
            ]
