...
async def test_improved_extraction():
    ...
    try:
        ...
        if not pdf_files:
            ...
            print("💡 Placez un fichier PDF dans le dossier uploads/ pour tester")
            return
        ...
        # Affichage d'un aperçu du texte
        ...
        if cv_info.get('work_experience'):
            ...
            print("💼 Expériences: Aucune trouvée")
        ...
        if cv_info.get('education'):
            ...
            print("🎓 Formation: Aucune trouvée")
        ...
        if cv_info.get('skills'):
            ...
            print("🛠️ Compétences: Aucune trouvée")
        
        # Langues
        if cv_info.get('languages'):
            print(f"🌍 Langues: {', '.join(cv_info['languages'])}")
        else:
            print("🌍 Langues: Aucune trouvée")
